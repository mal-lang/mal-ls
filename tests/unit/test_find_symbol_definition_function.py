...
mal_symbol_def_reaches_points = zip(
        ...
        [(13, 22),  # reaches
         (14, 14)],  # reaches single attack step
        [(6 , 8),
         (15, 6)])

parameters = chain(mal_symbol_def_extended_asset_main_points,
...
@pytest.mark.parametrize(
    "fixture_name,point,expected_result",parameters)
