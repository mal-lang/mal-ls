...
parameters = [("change_middle_of_file_single_line_client_messages",
               "mal_change_middle_of_file_single_line"),
              ...
              ("change_end_of_base_open_notification_client_messages",
               "mal_change_end_of_file"),
              ("change_middle_of_base_open_twice_client_messages",
               "mal_change_middle_of_file_twice"),
              ("change_whole_base_open_client_messages",
               "mal_change_whole_file")]
...
@pytest.mark.parametrize(
        ...
        parameters,
        ids=parameter_ids)
def test_changes(request: pytest.FixtureRequest,
